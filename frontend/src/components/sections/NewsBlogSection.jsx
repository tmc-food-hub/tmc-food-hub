      ...
      <div className="container">
        {isPreview ? (
          ...
          <div className="text-center mb-5">
            ...
            <p className="text-muted mx-auto" style={{ maxWidth: '600px', fontSize: '1rem', lineHeight: '1.6' }}>
              Food trends, delivery tips, restaurant spotlights, and platform updates — everything you need to stay hungry and informed.
            </p>
          </div>
        )}
        ...
        {isPreview === false && (
          <div className="featured-card-wrapper shadow" data-aos="fade-up">
            <div className="col-lg-6 p-4 p-md-5">
              ...
              <h2 className="featured-title mt-3">What's Cooking in 2026: The Food Trends Shaping How We Order</h2>
              <p className="featured-desc text-muted">
                From AI-powered recommendations to hyper-local dining experiences, 2026 is redefining how we discover, order, and enjoy food — blending convenience, community, and smarter technology into one seamless experience.
              </p>
              <div className="d-flex justify-content-between align-items-center mt-4">
                <span className="featured-meta text-muted">Feb 18, 2026 • 5 min read</span>
          ...
          {displayBlogs.length > 0 ? (
            displayBlogs.map((blog, index) => (
              <BlogCard
                ...
                {...blog}
                delay={index * 100}
                linkTo={isPreview ? '/news-and-blogs' : null}
              />
            ))
          ) : (
