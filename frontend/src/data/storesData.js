...
const LOGO = {
    ...
    steakAndCo: '/assets/images/service/resturant_logo/steak-and-co.svg',
    teHanaRamen: '/assets/images/service/resturant_logo/te-hana-ramen.svg',
};
...
export const defaultStores = [
    {
        ...
        menuItems: [
            ...
            { id: 104, category: 'Chickenjoy Meals', title: 'Chicken Strips Meal', description: 'Juicy chicken strips with honeydip sauce and fries.', price: 4.20, available: true, image: '/assets/images/service/jollibee/10-pc-Chicken-Nuggets.svg' },
            ...
            { id: 107, category: 'Burgers & Sandwiches', title: 'Jolly Crispy Burger', description: 'Crispy chicken fillet in a soft burger bun.', price: 3.00, available: true, image: '/assets/images/service/jollibee/Creamy-Ranch-Chicken-Sandwich.svg' },
            ...
            { id: 113, category: 'Desserts & Drinks', title: 'Pineapple Juice', description: 'Refreshing 100% pineapple juice, chilled.', price: 1.50, available: true, image: '/assets/images/service/jollibee/Coke Float.svg' },
        ],
        reviews: [
    ...
    },
    {
        ...
        menuItems: [
            ...
            { id: 206, category: 'Fully Loaded', title: 'Quarter Pounder Deluxe', description: 'Quarter-pound beef with fresh tomato and crispy lettuce.', price: 5.50, available: true, image: '/assets/images/service/mcdonald/Quarter-Pounder-with-Cheese.svg' },
            { id: 207, category: 'Fully Loaded', title: 'McSpicy Double', description: 'Double crispy spicy fillets with jalapeño sauce.', price: 4.80, available: true, image: '/assets/images/service/mcdonald/Crispy-Chicken-Ala-King-Solo.svg' },
            { id: 208, category: 'Fully Loaded', title: 'Mega McFries', description: 'Our largest serving of golden crispy fries.', price: 3.50, available: true, image: '/assets/images/service/mcdonald/BFF-Fries.svg' },
            { id: 209, category: 'McCafé', title: 'Caramel Macchiato', description: 'Espresso shots with vanilla syrup and caramel drizzle.', price: 3.80, available: true, image: '/assets/images/service/mcdonald/McCafe-Sea-Salt-Caramel-Iced-Coffee.svg' },
            { id: 210, category: 'McCafé', title: 'Mocha Frappe', description: 'Blended mocha with whipped cream and chocolate drizzle.', price: 3.50, available: true, image: '/assets/images/service/mcdonald/McCafe-Cereal-Milk-Iced-Coffee.svg' },
            { id: 211, category: 'McCafé', title: 'Strawberry Shake', description: 'Thick strawberry milkshake with real strawberries.', price: 3.00, available: true, image: '/assets/images/service/mcdonald/McFlurry-with-Oreo.svg' },
    ...
    },
    {
        ...
        menuItems: [
            { id: 301, category: 'Signature Rolls', title: 'Dragon Roll', description: 'Shrimp tempura, avocado, spicy mayo and tobiko.', price: 8.00, available: true, image: '/assets/images/service/sushiNori/California-Roll.svg' },
            { id: 302, category: 'Signature Rolls', title: 'Rainbow Roll', description: 'California roll topped with assorted sashimi.', price: 9.50, available: true, image: '/assets/images/service/sushiNori/Tuna-Roll.svg' },
            { id: 303, category: 'Signature Rolls', title: 'Volcano Roll', description: 'Spicy tuna inside, baked seafood mixture on top.', price: 9.00, available: true, image: '/assets/images/service/sushiNori/Tamago-Roll.svg' },
            ...
            { id: 305, category: 'Ramen & Hot Bowls', title: 'Tonkotsu Ramen', description: 'Rich creamy pork broth with chashu, soft egg, and nori.', price: 9.50, available: true, image: '/assets/images/service/sushiNori/Basic-Party-Platter.svg' },
            { id: 306, category: 'Ramen & Hot Bowls', title: 'Spicy Miso Ramen', description: 'Bold miso broth with chili, corn, butter, bean sprouts.', price: 9.00, available: true, image: '/assets/images/service/sushiNori/Classic-Party-Platter.svg' },
            { id: 307, category: 'Ramen & Hot Bowls', title: 'Gyudon (Beef Bowl)', description: 'Seasoned beef and onions over steamed Japanese rice.', price: 8.50, available: true, image: '/assets/images/service/sushiNori/Gyudon-Beef-Bowl.svg' },
            { id: 308, category: 'Ramen & Hot Bowls', title: 'Chirashi Bowl', description: 'Assorted sashimi over sushi rice with pickled ginger.', price: 12.00, available: true, image: '/assets/images/service/sushiNori/Chirasi-Bowl.svg' },
            { id: 309, category: 'Grills & Mains', title: 'Wagyu Steak', description: 'A5 wagyu sirloin, grilled to order with truffle butter.', price: 15.00, available: true, image: '/assets/images/service/sushiNori/Wagyu-Teppan-Donburi.svg' },
            { id: 310, category: 'Grills & Mains', title: 'Grilled Salmon Teriyaki', description: 'Norwegian salmon glazed with teriyaki sauce and sesame.', price: 11.00, available: true, image: '/assets/images/service/sushiNori/Karaage-Teriyaki.svg' },
            ...
            { id: 312, category: 'Beverages', title: 'Matcha Latte', description: 'Ceremonial grade matcha with steamed oat milk.', price: 4.00, available: true, image: '/assets/images/service/sushiNori/Matcha-Ube-Latte.svg' },
            { id: 313, category: 'Beverages', title: 'Yuzu Lemonade', description: 'Refreshing yuzu citrus with sparkling water.', price: 3.50, available: true, image: '/assets/images/service/sushiNori/Matcha-Yuzu-Lemonade.svg' },
            { id: 314, category: 'Beverages', title: 'Peach Oolong Tea', description: 'Brewed oolong tea with fresh peach and ice.', price: 3.00, available: true, image: '/assets/images/service/sushiNori/Matcha-Strawberry-Latte.svg' },
        ],
        reviews: [
    ...
    },
    {
        ...
        menuItems: [
            ...
            { id: 406, category: 'Fiesta Packages', title: '8-pc Paborito Bucket', description: '8 pcs chicken, 4 rice, 2 soup. Perfect for family sharing.', price: 22.00, available: true, image: '/assets/images/service/mangInasal/All-Chicken-Inasal-Family-Fiesta.svg' },
            ...
            { id: 409, category: 'Sidings', title: 'Garlic Fried Rice', description: 'Fragrant garlic rice perfect with any grilled dish.', price: 1.50, available: true, image: '/assets/images/service/mangInasal/Java-Rice.svg' },
            ...
            { id: 411, category: 'Desserts & Drinks', title: 'Mais con Yelo', description: 'Sweet corn kernels on crushed ice, drizzled with milk.', price: 2.00, available: true, image: '/assets/images/service/mangInasal/Crema-de-Leche-Halo-Halo.svg' },
            { id: 412, category: 'Desserts & Drinks', title: 'Pineapple Cooler', description: 'Chilled pineapple juice with a hint of mint.', price: 1.50, available: true, image: '/assets/images/service/mangInasal/Iced-Red-Gulaman.svg' },
        ],
        reviews: [
